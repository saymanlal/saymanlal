        ...
        >
          ...
          >
            ...
            <div className="relative mb-6">
              ...
              <input
                ...
                className={`w-full pl-10 pr-4 py-3 rounded-lg border transition-all duration-200 ${isDeveloper
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  className={`px-4 py-2 rounded-lg font-medium transition-all duration-200 ${!selectedOrg
                    ? isDeveloper
                ...
                {organizations.map((org) => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg font-medium transition-all duration-200 ${selectedOrg === org
                      ? isDeveloper
                        ? 'bg-green-400/20 text-green-400 border border-green-400/30'
                        : 'bg-blue-600 text-white'
                      : isDeveloper
              ...
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  className={`px-4 py-2 rounded-lg font-medium transition-all duration-200 ${!selectedYear
                    ? isDeveloper
                      ? 'bg-green-400/20 text-green-400 border border-green-400/30'
                      : 'bg-blue-600 text-white'
                    : isDeveloper
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredCertificates.map((certificate, index) => (
              <motion.div
                key={certificate.id}
                className={`rounded-xl overflow-hidden transition-all duration-300 card-hover ${isDeveloper
                  ...
                  <div className="relative overflow-hidden w-full h-48">
                    ...
                    <div className="absolute top-4 right-4">
                      {certificate.verified && (
                        <div className={`flex items-center space-x-1 px-2 py-1 rounded-full text-xs font-medium ${isDeveloper
                          ? 'bg-green-400/20 text-green-400 border border-green-400/30'
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      <h3 className={`text-lg font-semibold mb-2 ${isDeveloper ? 'text-green-400' : 'text-gray-900'
                        }`}>
                        {certificate.title}
                      </h3>
                      <p className={`text-sm font-medium mb-1 ${isDeveloper ? 'text-blue-400' : 'text-blue-600'
                        }`}>
                        {certificate.organization}
                      </p>
                    </div>
                    <div className={`p-2 rounded-lg ${isDeveloper ? 'bg-green-400/20 text-green-400' : 'bg-blue-50 text-blue-600'
                      }`}>
                  ...
                  {/* Dates */}
                  <div className={`flex items-center space-x-4 text-sm mb-4 ${isDeveloper ? 'text-gray-400' : 'text-gray-600'
                    }`}>
                  ...
                  {certificate.expiry_date && (
                    <div className={`text-sm mb-4 ${isExpired(certificate.expiry_date)
                      ? 'text-red-500'
                  ...
                  {certificate.credential_id && (
                    <div className={`text-xs mb-4 ${isDeveloper ? 'text-gray-400 font-mono' : 'text-gray-500'
                      }`}>
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {certificate.skills.slice(0, 3).map((skill) => (
                      <span
                        key={skill}
                        className={`px-2 py-1 rounded-md text-xs font-medium ${isDeveloper
                    ...
                    {certificate.skills.length > 3 && (
                      <span className={`px-2 py-1 rounded-md text-xs ${isDeveloper ? 'text-gray-400' : 'text-gray-500'
                        }`}>
                    ...
                    <div className="flex space-x-2">
                      {certificate.credential_url && (
                        <a
                          ...
                          className={`flex items-center space-x-1 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${isDeveloper
          ...
          {filteredCertificates.length === 0 && (
            ...
            >
              ...
              <h3 className={`text-xl font-semibold mb-2 ${isDeveloper ? 'text-green-400' : 'text-gray-900'
                }`}>
          ...
          {/* Stats Summary */}
          <motion.div
            className={`mt-16 p-8 rounded-xl ${isDeveloper
              ? 'glass-dark border-green-500/30'
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-center">
              <div>
                <div className={`text-3xl font-bold mb-2 ${isDeveloper ? 'text-green-400' : 'text-blue-600'
                  }`}>
                  {certificates.length}
                </div>
                <div className={`text-sm ${isDeveloper ? 'text-gray-300' : 'text-gray-600'
                  }`}>
                  Total Certificates
                </div>
              </div>
